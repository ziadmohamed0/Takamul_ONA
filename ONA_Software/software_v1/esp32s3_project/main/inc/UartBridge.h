...
namespace Takamul {
    ...
    public:
        ...
        /**
         * @brief Stop the RX task safely, then release UART resources.
         *        Waits for the task to fully exit before deleting the driver.
         *        Safe to call from any context (e.g. SleepManager shutdown).
         */
        void stop();
    ...
    private:
        ...
        TaskHandle_t      m_task_handle = nullptr;   // FIX: track task handle for safe stop()
    };
